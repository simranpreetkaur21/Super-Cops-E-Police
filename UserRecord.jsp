<%-- 
    Document   : UserRecord
    Created on : Jul 29, 2015, 1:55:01 PM
...
<body class="templatemo_flower_2">
	<div id="main_container">
		<div class="container" id="about">
			<div class="row col-wrap">			 
				...
				<div id="right_container" class="col col-md-9 col-sm-12">
					<div class="row"><div class="col col-md-12"><h1>User Records</h1></div></div>
					<article class="row">							
        ...
        PreparedStatement pstmt=conn.prepareStatement("select * from SUPERUSER12");
        
    
        %>
       
           <table color="white" border="4px" style=" border-style: double;border-width: 2px;border-color:blanchedalmond; border-radius: 2px;font-size: 20px">
               <tr>
                    <td>User Id</td>
                    <td>Name</td>
                    <td>Father's Name</td>
